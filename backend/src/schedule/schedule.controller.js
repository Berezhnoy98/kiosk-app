...
let ScheduleController = (() => {
    let _classDecorators = [(0, common_1.Controller)('schedule')];
    ...
    var ScheduleController = _classThis = class {
    ...
    (() => {
        ...
        _update_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Put)(':id')];
