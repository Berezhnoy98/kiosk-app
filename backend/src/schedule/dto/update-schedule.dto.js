...
let UpdateScheduleDto = (() => {
    ...
    return _a = class UpdateScheduleDto {
            constructor() {
                ...
                this.time = (__runInitializers(this, _date_extraInitializers), __runInitializers(this, _time_initializers, void 0));
                this.location = (__runInitializers(this, _time_extraInitializers), __runInitializers(this, _location_initializers, void 0));
        ...
        (() => {
            ...
            _date_decorators = [(0, class_transformer_1.Type)(() => Date), (0, class_validator_1.IsDate)(), (0, class_validator_1.IsOptional)()];
            _time_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsOptional)()];
